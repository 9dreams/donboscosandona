...
export default function Home({ data, elementi }) {
  return (
    <Layout>
      <LandingHero
        opacity={0.5}
        title='Pet Shop di orsetto oro '
        description='Un angolo di paradiso per i nostri amici a quattro zampe. 
        Il nostro pet shop è un luogo dove troverai tutto ciò di cui hai bisogno per coccolare il tuo animale'
        buttonUrl=''
