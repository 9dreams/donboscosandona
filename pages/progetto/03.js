    ...
    return (
        <Layout>
            ...
            <div className="max-w-[1200px] mx-auto px-4 md:px-8">
                <h3>3. IL COORDINAMENTO E L’ANIMAZIONE DELL’AZIONE EDUCATIVA</h3>
            </div><br /><br />

            <div className="max-w-[1200px] mx-auto px-4 md:px-8">
                <h6>L’animazione pastorale è responsabilità innanzi tutto della comunità salesiana, in<br /> particolare del direttore e del Consiglio della comunità.<br /><br />
            ...
            <div className="max-w-[1200px] mx-auto px-4 md:px-8">
                <h5>3.1. Gli Organismi direttivi e di coordinamento</h5>
            </div>


            <div className="max-w-[1200px] mx-auto px-4 md:px-8">
                <h5>3.1.1. Il Consiglio della casa</h5>
            </div>
            <div className="max-w-[1200px] mx-auto px-4 md:px-8">
                <h5>
            ...
            <div className="max-w-[1200px] mx-auto px-4 md:px-8">
                <h5>3.1.2. Il Consiglio della CEP</h5>
            </div>
            <div className="max-w-[1200px] mx-auto px-4 md:px-8">
                <h5>
            ...
            <div className="max-w-[1200px] mx-auto px-4 md:px-8">
                <h5>3.1.3. L’Equipe di Pastorale Giovanile</h5>
            </div>
            <div className="max-w-[1200px] mx-auto px-4 md:px-8">
                <h5>
            ...
            <div className="max-w-[1200px] mx-auto px-4 md:px-8">
                <h5>3.2. I ruoli di coordinamento dell’attività didattica e pastorale</h5>
            </div>
            <div className="max-w-[1200px] mx-auto px-4 md:px-8">
                <h5>
            ...
            <div className="max-w-[1200px] mx-auto px-4 md:px-8">
                <h5>3.2.1. Il Direttore dell’Opera Oratorio Don Bosco.</h5>
            </div>
            <div className="max-w-[1200px] mx-auto px-4 md:px-8">
                <h5>
            ...
            <div className="max-w-[1200px] mx-auto px-4 md:px-8">
                <h5>3.2.2. Il Coordinatore Pastorale (Catechista).</h5>
            </div>
            <div className="max-w-[1200px] mx-auto px-4 md:px-8">
                <h5>
            ...
            <div className="max-w-[1200px] mx-auto px-4 md:px-8">
                <h5>3.2.3. L’Economo o coordinatore della gestione amministrativa</h5>
            </div>
            <div className="max-w-[1200px] mx-auto px-4 md:px-8">
                <h5>
            ...
            <div className="max-w-[1200px] mx-auto px-4 md:px-8">
                <h5>3.2.4. Il Vice-Direttore del CFP</h5>
            </div>
            <div className="max-w-[1200px] mx-auto px-4 md:px-8">
                <h5>
            ...
            <div className="max-w-[1200px] mx-auto px-4 md:px-8">
                <h5>1.6.5. Settore Informatico: operatore informatico</h5>
            </div>
            <div className="max-w-[1200px] mx-auto px-4 md:px-8">
                <h5>
            ...
            <div className="max-w-[1200px] mx-auto px-4 md:px-8">
                <h5>3.2.6. Il Coordinatore dell’Orientamento.</h5>
            </div>
            <div className="max-w-[1200px] mx-auto px-4 md:px-8">
                <h5>
            ...
            <div className="max-w-[1200px] mx-auto px-4 md:px-8">
                <h5>3.2.7. Il Coordinatore di settore.</h5>
            </div>
            <div className="max-w-[1200px] mx-auto px-4 md:px-8">
                <h5>
            ...
            <div className="max-w-[1200px] mx-auto px-4 md:px-8">
                <h5>3.2.8. Il Coordinatore di classe.</h5>
            </div>
            <div className="max-w-[1200px] mx-auto px-4 md:px-8">
                <h5>
            ...
            <div className="max-w-[1200px] mx-auto px-4 md:px-8">
                <h5>3.2.9. I rappresentanti dei genitori</h5>
            </div>
            <div className="max-w-[1200px] mx-auto px-4 md:px-8">
                <h5>
            ...
            <div className="max-w-[1200px] mx-auto px-4 md:px-8">
                <h5>3.2.10. I rappresentanti di classe degli alunni.</h5>
            </div>
            <div className="max-w-[1200px] mx-auto px-4 md:px-8">
                <h5>
            ...
            <div className="max-w-[1200px] mx-auto px-4 md:px-8">
                <h5>3.3.  Le strutture di partecipazione</h5>
            </div>
            <div className="max-w-[1200px] mx-auto px-4 md:px-8">
                <h5>
            ...
            <div className="max-w-[1200px] mx-auto px-4 md:px-8">
                <h5>3.3.1. Assemblea formatori</h5>
            </div>
            <div className="max-w-[1200px] mx-auto px-4 md:px-8">
                <h5>
            ...
            <div className="max-w-[1200px] mx-auto px-4 md:px-8">
                <h5>3.3.2. Commissioni e dipartimenti</h5>
            </div>
            <div className="max-w-[1200px] mx-auto px-4 md:px-8">
                <h5>
            ...
            <div className="max-w-[1200px] mx-auto px-4 md:px-8">
                <h5>3.3.3. Consiglio di classe.</h5>
            </div>
            <div className="max-w-[1200px] mx-auto px-4 md:px-8">
                <h5>
            ...
            <div className="max-w-[1200px] mx-auto px-4 md:px-8">
                <h5>3.3.4. Assemblea di classe</h5>
            </div>
            <div className="max-w-[1200px] mx-auto px-4 md:px-8">
                <h5>
