  ...
  return (
    <Layout>
      ...
      <Paragraph
        ...
        columnCount={2}
      >
        Il nuovo Regolamento Europeo (UE) 2016/679 del Parlamento Europeo (GDPR)
        relativo alla protezione dei dati è stato pubblicato sulla GUUE del 4
        maggio 2016, è entrato in vigore il 24 maggio del 2016 ed è divenuto
        pienamente operativo negli Stati membri dal 25 maggio 2018. Tale
        regolamento consolida e rende più omogenea la protezione dei dati
        personali dei cittadini e dei residenti dell’Unione Europea evitando
        lacune di tutela in ambito europeo e consacrando il diritto alla
        protezione dei dati personali degli interessati tra i diritti
        fondamentali e costituzionali. In conformità a quanto previsto dal
        Regolamento Europeo (UE) 2016/679 per la protezione dei dati personali
      ...
      >
        ...
        Ai sensi dell’art. 13 del Regolamento UE 2016/679 (d’ora in poi
        Regolamento o anche solo GDPR) ti descriviamo le modalità di trattamento
        dei dati personali degli utenti che consultano questo sito web.
        <br />
        Ti precisiamo prima di tutto che il sito internet www.donboscosandona.it
        è di titolarità e gestito da Fondazione FP INE - is - SFP Don Bosco, via
        XIII Martiri, 86 - 30027 San Donà di Piave (VE).
        <br />
        Raccogliamo i dati da te inseriti e i dati di navigazione per
        l’esecuzione del contratto.
        <br />
        Nel prosieguo, Ti illustreremo, quindi, le modalità e finalità di
        gestione del sito in riferimento al trattamento dei dati personali
        utilizzati nell’una e nell’altra ipotesi.
        <br />
        Ti precisiamo fin d’ora che il trattamento è effettuato in ossequio ai
        principi di liceità e correttezza, in conformità alla normativa vigente.
        <br />
        <br />
        La presente informativa non è da considerarsi valida per altri siti web
        eventualmente consultabili tramite links presenti su questo sito
        internet, rispetto ai quali non siamo in alcun modo responsabile.
        <br />
        <br />
      </Paragraph>
      ...
      >
        ...
        sito internet è Fondazione FP INE - is - SFP Don Bosco Via XIII Martiri
        86 - 30027
        <br />
        <br /> San Donà di Piave (VE). Il Responsabile della protezione dei dati
        (RPD o DPO) è contattabile al seguente indirizzo:
        marco.bernabe@ordineavvocativicenza.it o telefonicamente al +39 392 154 9739.
      </Paragraph>
      ...
      >
        ...
        newsletter da noi proposte, per crearti (eventualmente) un account
        utente personale o per stipulare un contratto con noi. Questi dati sono
        da noi trattati per le seguenti finalità:
        <br />
        <br />
        <strong>1) </strong>la vendita o l’acquisto dei prodotti e servizi
        reperiti nel sito web e per le attività che ne siano direttamente o
        indirettamente connesse come, ad esempio, l’instaurazione e l’esecuzione
        del contratto o l’esecuzione di eventuali trattative precontrattuali in
        funzione della conclusione del successivo contratto, nonché per tutti
        gli obblighi direttamente o indirettamente connessi allo stesso.
        <br />
        <br />
        <strong>2) </strong>per obblighi di legge di natura fiscale,
        amministrativa, tributaria etc. (ad esempio amministrazione
        clienti/fornitori; gestione del rapporto contrattuale; fatturazione;
        gestione ordini; incassi e pagamenti, consegna del bene).
        <br />
        <br />
        <strong>3) </strong>per il perseguimento del legittimo interesse del
        titolare (a titolo esemplificativo ma non esaustivo: difesa in giudizio
        nel caso fosse necessario, ma anche marketing diretto) in ogni caso nel
        rispetto dei prevalenti diritti e libertà fondamentali dell’interessato
        che richiedono la protezione dei dati personali.
        <br />
        <br />
        <strong>4) </strong>per l’invio di newsletter relative a prodotti e
        servizi o eventi riconducibili all’Ente su specifica richiesta
        dell’interessato.
        <br />
        <br />
        In questi casi la base giuridica del trattamento è costituita
        dall’adempimento del contratto e dall’obbligo legale di trattare i dati
        (cfr. GDPR art. 6 lett. b), c) f)), nonché dal tuo consenso per le
        newsletter (GDPR art. 6 lett a).
        <br />
        <br />
        Nel caso (solo eventuale, come anticipato precedentemente) di
        trattamento{' '}
        <strong>
          di dati particolari, la base giuridica di trattamento è costituita
        </strong>{' '}
        dal fatto che il trattamento è effettuato da un Ente ecclesiastico che
        persegue finalità religiose relativamente al trattamento dei membri, gli
        ex membri o le persone che hanno regolari contatti con l'ente a motivo
        delle sue finalità quando i dati personali non sono comunicati
        all’esterno e dal consenso nelle residue ipotesi (GDPR art. 9 lett. A)
        D) E) F)).
        <br />
        <br />
        Ti precisiamo infine che l'invio facoltativo, esplicito e volontario di
        messaggi agli indirizzi di contatto dell’Ente, nonché la compilazione e
        l'inoltro dei moduli presenti sul sito comportano l'acquisizione dei
        dati di contatto del mittente, necessari a rispondere, nonché di tutti i
      ...
      >
        ...
        <br />
        <br />
        Viene, invece, fatto uso di cookie di sessione (non persistenti) in modo
        strettamente limitato a quanto necessario per la navigazione sicura ed
        efficiente dei siti. La memorizzazione dei cookie di sessione nei
        terminali o nei browser è sotto il controllo dell'utente, laddove sui
        server, al termine delle sessioni HTTP, informazioni relative ai cookie
        restano registrate nei log dei servizi.
        <br />
        <br />
        Il sito si appoggia a Google Analytics che svolge profilazione in forma
        anonima, inoltre è possibile condivisione di materiale con Facebook
        <br />
        <br />
        c. <strong>Destinatari dei dati personali</strong>
        <p>
          I tuoi dati comunicati per la conclusione del contratto saranno
          conservati per tutta la durata del contratto e per il periodo di tempo
          successivo prescritto da legge. In particolare si precisa che le
          scritture contabili, le fatture e la corrispondenza saranno conservati
          per 10 anni come previsto dalla legge; i dati necessari alla gestione
          di un eventuale contenzioso o recupero credito saranno conservati fino
          alla definizione del contenzioso.
          <br />
          <br />I dati forniti per l’iscrizione alle newsletter saranno
          conservati per il periodo in cui il servizio è attivo.
        </p>
        d. <strong>Obbligo di conferire i dati</strong>
        <p>
          Il conferimento dei dati è obbligatorio e necessario per lo
          svolgimento del contratto stipulato tra te e il Titolare del
          trattamento e per ricevere le newsletter, per cui l’eventuale rifiuto
          di conferire i dati personali richiesti comporta la cessazione del
          rapporto.
          <br />
          <br />
          Il titolare rende noto, inoltre, che l'eventuale non comunicazione, o
          comunicazione errata, di una delle informazioni obbligatorie, ha come
          conseguenza l'impossibilità del titolare di garantire la congruità del
          trattamento stesso ai patti contrattuali per cui esso sia eseguito e
          la possibile mancata corrispondenza dei risultati del trattamento
          stesso agli obblighi imposti dalla normativa fiscale, amministrativa o
          del lavoro cui esso è indirizzato.
        </p>
        f. <strong>Diritti dell’interessato</strong>
        <p>
          Potrai richiedere in ogni momento al titolare del trattamento
          l’accesso ai dati personali che ti riguardano e la rettifica o la
          cancellazione degli stessi o la limitazione del trattamento o di
          opporsi al loro trattamento (artt. 15 e ss. Del Regolamento), nonché
          il diritto alla portabilità dei dati, come previsto all’art. 13 comma
          2 lettera b) GDPR.
          <br />
          <br />
          La cancellazione non è consentita per i dati contenuti negli atti che
          devono obbligatoriamente essere conservati per legge.
          <br />
          <br />
          Potrai revocare il consenso in qualsiasi momento, senza pregiudicare
          la liceità del trattamento basata sul consenso prestato prima della
          revoca.
          <br />
          <br />
          Hai, inoltre, il diritto di proporre reclamo al Garante, come previsto
          dall'art. 77 del Regolamento stesso, o di adire le opportune sedi
          giudiziarie (art. 79 del Regolamento) nel caso in cui tu ritenga che
          il trattamento dei dati personali a te riferiti effettuato attraverso
          questo sito avvenga in violazione di quanto previsto dal Regolamento.
        </p>
        g. <strong>Modalità di esercizio dei diritti</strong>
        <p>
          Potrai in qualsiasi momento esercitare i diritti con raccomandata a.r.
          a Associazione C.F.P. CNOS/FAP Don Bosco Via XIII Martiri 86 – 30027
          San Donà di Piave (VE), oppure inviando una e-mail all’indirizzo
          privacy@donboscosandona.it indicando nell’oggetto la dicitura “accesso
          privacy”.
        </p>
        <br />
        <br />
      ...
      <Paragraph imageUrl='https://www.netdream.it/sites/netdream.it/files/blog/cookies.jpg'>
        ...
        <p>
          ...
          sulla posizione tramite cookie e altre tecnologie simili. Questi
          soggetti terzi raccolgono queste informazioni per i seguenti scopi e
        ...
        <p>
          ...
          Queste tecnologie includono cookie, javascript, entity tags e
          archiviazione locale HTML. La maggior parte dei browser web può essere
          impostata per accettare o rifiutare l’utilizzo di alcune o tutte
        ...
        <p>
          ...
          a valutare il volume di utilizzo delle funzionalità sul nostro sito
          web. Ci mostrano come i visitatori interagiscono, se ci sono errori di
          navigazione, il livello di utilizzo di determinate pagine web. Quando
          queste tecnologie vengono utilizzate per il monitoraggio delle
          prestazioni, non vengono raccolte informazioni che ti identificano.
          <br />
          <br />
          Alcune di queste tecnologie migliorano la facilità d’uso del sito web
        ...
        <Paragraph imageUrl='https://images.everyeye.it/img-notizie/cosa-succede-quando-accettano-cookie-cosa-serve-consenso-v3-529275-1280x720.webp'>
          ...
          <p>
            ...
            cookie sono necessari per il funzionamento del sito, raccogliendo
            dati di utilizzo in modo aggregato e in forma anonima.
            <br />
