...
export default function Home({ datiArticoli }) {
    return (
        <Layout>
            ...
            <center><Button variant="outlined" onClick={() => window.open('/docs/trasparenza/Verbale_24_febbrario_2023.pdf', '_blank')} style={{ fontSize: '30px', width: '700px', height: '160px', textTransform: 'none' }}>Verbale assemblea 24 Febbraio 2023<br />Approvazione del Progetto di Fusione</Button><br /><br /><br /></center>
            ...
            <center><Button variant="outlined" onClick={() => window.open('/docs/trasparenza/Griglia_di_rivelazione.zip', '_blank')} style={{ fontSize: '30px', width: '380px', height: '100px', textTransform: 'none' }}>Griglia di rivelazione</Button><br /><br /></center>
