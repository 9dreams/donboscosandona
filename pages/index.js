  ...
  return (
    <Layout>
      <LandingHero
        ...
        description='Unlock your world with English!'
        imageUrl='https://as2.ftcdn.net/v2/jpg/02/38/56/47/1000_F_238564760_rtggKMhDNkmCOsSIARQDWv0koIE58wQp.jpg'
        height='100vh'
      />
   ...
   <Paragraph
        title='Perché l inglese è importante'
        subtitle='studio facile'
        rightImageUrl='https://www.mlaworld.com/wp-content/uploads/2021/07/inglese-italiano.jpg'
      >
        
L'inglese è una lingua fondamentale nel mondo moderno per diversi motivi. Innanzitutto, è la lingua più parlata a livello globale, utilizzata da milioni di persone come lingua madre e seconda lingua. Questo la rende un ponte comunicativo tra culture diverse, facilitando il dialogo e la comprensione reciproca.

Inoltre, l'inglese è la lingua degli affari internazionali. Molte aziende richiedono competenze in inglese per poter operare efficacemente in un mercato globale. Conoscere l'inglese apre quindi a numerose opportunità lavorative e professionali.

Infine, l'inglese è anche la lingua della scienza, della tecnologia e della cultura pop. Molti dei più importanti studi, innovazioni e opere artistiche sono disponibili in inglese, e comprenderli permette di accedere a un vasto mondo di conoscenze e ispirazioni.

In sintesi, imparare l'inglese non solo arricchisce il proprio bagaglio culturale, ma offre anche vantaggi pratici in un mondo sempre più interconnesso.
      </Paragraph>
      <Products
        title='I prodotti'
...
let slides2 = [
  {
    ...
    descrizione:
      'Scopri tutti i segreti del nostro Centro con il tour virtuale!',
    immagine:
      'https://st3.depositphotos.com/3898909/15009/v/950/depositphotos_150099004-stock-illustration-design-concept-of-word-english.jpg',
    buttonText: 'Scopri di più!',
    buttonUrl: 'https:...',
  },
  {
    titolo: 'Concorso nazionale inglese',
    descrizione:
      "I concorsi nazionali in inglese rappresentano un'importante opportunità per studenti di tutte le età. Partecipare a questi eventi non solo migliora le competenze linguistiche, ma favorisce anche l'autonomia e la fiducia in sé. Inoltre, offre la possibilità di confrontarsi con coetanei e di mettersi alla prova in un contesto stimolante. Questi concorsi, spesso supportati da scuole e istituzioni, incoraggiano l'apprendimento attivo e l'interesse per la cultura anglofona, rendendo l'inglese un'esperienza coinvolgente e gratificante.",
      immagine:
      'https://bresciagiovani.it/wp-content/uploads/2017/06/inglese.jpg',
  },
]
...
let prodotti3 = [
    {
      ...
      category: '',
      description:
        'La scuola si occupa di dare libri e computer totalmente gratis',
      immagineUrl:
        'https://c8.alamy.com/compit/p1e1a4/dizionario-inglese-libro-isolato-p1e1a4.jpg',
    },
    {
      title: 'intrattenitivo',
      category: '',
      description:
        "quiz e giochi per rendere la lingua piu divertente e intratenitivo.",
      immagineUrl:
        'https://simulatore.simone.it/res/prova/simulatore.png',
      url: '/energia',
    },
    {
      title: 'diploma',
      category: '',
      description:
        "con la nostra scuola ricevi un diploma di lingua inglese.",
      immagineUrl:
        'https://png.pngtree.com/png-clipart/20220430/original/pngtree-diploma-certificate-template-png-image_7598348.png',
      url: '/informatico',
    },
  ]