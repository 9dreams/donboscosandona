export default function Servizi() {
  return (
    <>
      <title>
        Economia domestica - Emporio Solidale
      </title>
        ...
        <div className="w-full bg-[url('/images/servizi_favicon/sfondo.png')] bg-repeat bg-center">
          ...
          <div className="flex flex-col px-5 md:px-10 lg:pl-64 pt-8 md:pt-14 pb-10 md:pb-20 gap-y-4 w-full md:w-4/5 lg:w-1/2">
            ...
            <p className="text-sm md:text-md text-white">
              È un laboratorio per la promozione delle conoscenze degli aspetti
              pratici della vita di famiglia.
            </p>
            <p className="text-sm md:text-md text-white">
              ...
              nostro, si trovano a volte in difficoltà nel gestire soprattutto i
              figli che si devono integrare con una quotidianità diversa da
              quella abituale.
            </p>
            <p className="text-sm md:text-md text-white">
