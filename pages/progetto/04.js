    ...
    return (
        <Layout>
            ...
            <div className="max-w-[1200px] mx-auto px-4 md:px-8">
                <h3>4. IL PATTO EDUCATIVO</h3>
            </div><br /><br />

            <div className="max-w-[1200px] mx-auto px-4 md:px-8">
                <h6>Nella comunità educativa uno spazio importante è riservato a genitori e allievi. In<br /> sede d’iscrizione, viene condiviso il patto educativo tra le parti. Il CFP è rappresentato<br /> dal Direttore o da persona da lui delegata.<br /><br />
                    In relazione a questo progetto educativo...
                </h6>
            </div><br /><br />

            <div className="max-w-[1200px] mx-auto px-4 md:px-8">
                <h5>Il CFP si impegna a:</h5>
            </div>
            <div className="max-w-[1200px] mx-auto px-4 md:px-8">
                <h5>
            ...
            <div className="max-w-[1200px] mx-auto px-4 md:px-8">
                <h5>Gli allievi si impegnano a:</h5>
            </div>
            <div className="max-w-[1200px] mx-auto px-4 md:px-8">
                <h5>
            ...
            <div className="max-w-[1200px] mx-auto px-4 md:px-8">
                <h5>1.3. La Formazione Professionale</h5>
            </div>
            <div className="max-w-[1200px] mx-auto px-4 md:px-8">
                <h5>
            ...
            <div className="max-w-[1200px] mx-auto px-4 md:px-8">
                <h5>1.5. L’offerta formativa professionalizzante del CFP</h5>
            </div>
            <div className="max-w-[1200px] mx-auto px-4 md:px-8">
                <h5>
            ...
            <div className="max-w-[1200px] mx-auto px-4 md:px-8">
                <h5>1.6.1. Settore Meccanico macchine utensili: operatore meccanico</h5>
            </div>
            <div className="max-w-[1200px] mx-auto px-4 md:px-8">
                <h5>
            ...
            <div className="max-w-[1200px] mx-auto px-4 md:px-8">
                <h5>1.6.3. Settore Motoristico: operatore alla riparazione di carrozzeria</h5>
            </div>
            <div className="max-w-[1200px] mx-auto px-4 md:px-8">
                <h5>
            ...
            <div className="max-w-[1200px] mx-auto px-4 md:px-8">
                <h5>1.6.4. Settore Elettrico: operatore elettrico</h5>
            </div>
            <div className="max-w-[1200px] mx-auto px-4 md:px-8">
                <h5>
            ...
            <div className="max-w-[1200px] mx-auto px-4 md:px-8">
                <h5>1.6.6. Settore Energie rinnovabili: operatore di impianti termoidraulici ed impianti per il risparmio energetico</h5>
            </div>
            <div className="max-w-[1200px] mx-auto px-4 md:px-8">
                <h5>
