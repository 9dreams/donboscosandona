...
export default function Pagina() {
  return (
    <Layout>
      ...
      <Paragraph
        title="I nostri pomeriggi"
        subtitle="Il divertimento sarà assicurato!!!
        Ore 15.30: ci aspettano i super giochi a squadre che andranno ad assegnare parecchi punti per la classifica generale!
        "
      >
        Quando saremo in oratorio ci sfideremo a:
        <li><strong>Basket</strong></li>
        <li><strong>Volley</strong></li>
        <li><strong>Ping Pong</strong></li>
        <li><strong>Calcio</strong></li>
        <li><strong>Palla guerra</strong></li>
        <li><strong>Racchettoni</strong></li>
        <br></br>
        O a sport più tranquilli come:
