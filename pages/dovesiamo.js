  ...
  return (
    <Layout>
      ...
      <div class="flex flex-col items-center">
        {/* Emporio Solidale */}
        <div class="bg-white rounded-2xl shadow-xl flex flex-col lg:flex-row p-8 mt-32 w-11/12 max-w-7xl justify-center">
          <div class="flex flex-col w-full lg:w-6/12 space-y-6">
            <h2 class="text-3xl md:text-4xl lg:text-5xl text-center font-bold text-[#780202]">
            ...
            <div>
              ...
              <div class="grid grid-cols-1 gap-12 mt-8">
                <div class="flex flex-col items-center p-4 bg-gray-100 rounded-lg shadow">
                  ...
                  <span class="text-lg mt-6 text-gray-600 text-center">
          ...
          <div class="w-full lg:w-1/4 h-full lg:ml-20 rounded-lg overflow-hidden">
            <iframe
        ...
        {/* Centro di Ascolto */}
        <div class="bg-white rounded-2xl mt-20 shadow-xl flex flex-col lg:flex-row p-8 w-11/12 max-w-7xl justify-center">
          <div class="flex flex-col w-full lg:w-6/12 space-y-6">
            <h2 class="text-3xl md:text-4xl lg:text-5xl text-center font-bold text-[#780202]">
        ...
        {/* Documenti Necessari */}
        <div class="flex flex-col lg:flex-row w-11/12 max-w-7xl mt-20 gap-5 justify-center mb-20">
          <div class="flex flex-col w-full lg:w-11/12">
            <h1 class="font-semibold text-2xl md:text-3xl text-[#780202] mb-10 text-center">
              Per avere l'assistenza è necessario presentare i seguenti
              documenti:
            </h1>
            <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 text-gray-700 gap-5 items-center">
              {/* Documento 1 */}
              <div class="flex flex-col border border-gray-200 rounded-3xl p-5 items-center w-full h-full">
                <img
                  src="images/ci.jpg"
                  class="w-full h-48 sm:h-64 md:h-80 object-contain mb-3"
                  alt="Carta di Identità"
                />
              ...
              <div class="flex flex-col border border-gray-200 rounded-3xl p-5 items-center w-full h-full">
                <img
                  ...
                  class="w-full h-48 sm:h-64 md:h-80 object-contain mb-3"
                  alt="Stato di Famiglia"
                />
                <h1 class="text-md text-center">
                  <strong>A.i.t.s.a.m.</strong>Stato di Famiglia
                </h1>
              </div>
              ...
              <div class="flex flex-col border border-gray-200 rounded-3xl p-5 items-center w-full h-full">
                <img
                  ...
                  alt="Busta Paga"
                />
                <h1 class="text-md text-center">Busta paga/Pensione</h1>
              </div>
              ...
              <div class="flex flex-col border border-gray-200 rounded-3xl p-5 items-center w-full h-full">
                <img
                  ...
                  class="w-full h-48 sm:h-64 md:h-80 object-contain mb-3"
                  alt="Certificato Disoccupazione"
                />
                <h1 class="text-md text-center">
                  Certificato Disoccupazione
                </h1>
              </div>
              ...
              <div class="flex flex-col border border-gray-200 rounded-3xl p-5 items-center w-full h-full">
                <img
                  ...
                  alt="Modulo ISEE"
                />
                <h1 class="text-md text-center">Modulo ISEE</h1>
              </div>
              ...
              <div class="flex flex-col border border-gray-200 rounded-3xl p-5 items-center w-full h-full">
                <img
                  ...
                  class="w-full h-48 sm:h-64 md:h-80 object-contain mb-3"
                  alt="Ricevuta Affitto"
                />
                <h1 class="text-md text-center">Ricevuta Affitto</h1>
              </div>
              ...
              <div class="flex flex-col border border-gray-200 rounded-3xl p-5 items-center w-full h-full">
                <img
                  ...
                  alt="Altri Documenti"
                />
                <h1 class="text-md text-center">Altri Documenti</h1>
              </div>
            </div>
          </div>
        </div>
