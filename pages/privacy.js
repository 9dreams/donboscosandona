        ...
        <Layout>
            ...
            >
                ...
                >
                    ...
                    <br /> Ai sensi dell’art. 13 e 14 del GDPR Ti comunichiamo che il Titolare del trattamento dei tuoi dati personali forniti attraverso il sito internet è Associazione C.F.P. CNOS/FAP Don Bosco Via XIII Martiri 86 - 30027
                    <br />
                    <br /> San Donà di Piave (VE). Il Responsabile della protezione dei dati (RPD o DPO) è contattabile al seguente indirizzo: dpo@salesianinordest.it o telefonicamente al 041.2030438.
                ...
                >
                    Sono i dati personali da te <strong>inseriti nei campi di registrazione</strong>, per accedere alle newsletter da noi proposte, per crearti (eventualmente) un  account utente personale o per stipulare un contratto con noi. Questi dati sono da noi trattati per le seguenti finalità:
                    <br />
                    <br />
                    <strong>1) </strong>la vendita o l’acquisto dei prodotti e servizi reperiti nel sito web e per le attività che ne siano direttamente o indirettamente connesse come, ad esempio, l’instaurazione e l’esecuzione del contratto o l’esecuzione di eventuali trattative precontrattuali in funzione della conclusione del successivo contratto, nonché per tutti gli obblighi direttamente o indirettamente connessi allo stesso.

                    <br />
                    <br />

                    <strong>2) </strong>per obblighi di legge di natura fiscale, amministrativa, tributaria etc. (ad esempio amministrazione clienti/fornitori; gestione del rapporto contrattuale; fatturazione; gestione ordini; incassi e pagamenti, consegna del bene).

                    <br />
                    <br />

                    <strong>3) </strong>per il perseguimento del legittimo interesse del titolare (a titolo esemplificativo ma non esaustivo: difesa in giudizio nel caso fosse necessario, ma anche marketing diretto) in ogni caso nel rispetto dei prevalenti diritti e libertà fondamentali dell’interessato che richiedono la protezione dei dati personali.

                    <br />
                    <br />

                    <strong>4) </strong>per l’invio di newsletter relative a prodotti e servizi o eventi riconducibili all’Ente su specifica richiesta dell’interessato.
            ...
            <Paragraph
                ...
                imageUrl="https://www.netdream.it/sites/netdream.it/files/blog/cookies.jpg"
            ...
            >
                ...
                <Paragraph
                    ...
                    imageUrl="https://images.everyeye.it/img-notizie/cosa-succede-quando-accettano-cookie-cosa-serve-consenso-v3-529275-1280x720.webp"
